"""Spherical / pinhole helpers shared by the LUNA pano modules.

Mirror of `Rethink_pano_new_exp/vggt/layers/pano_position.py`, adapted to live
inside the VGGT-Omega package tree.
"""
