...
from vggt.layers.pano_position import (
...
def sample_pano_windows(
    ...
    Args:
        pano_images: [B, 3, H, W] or [3, H, W] equirectangular image tensor.
        yaw, pitch: View centers in radians, shape [S].
        fov: Scalar, [S], or [S, 2] radians. When two values are provided
            they are interpreted as (fov_x, fov_y).
    """
    ...
    windows = _sample_equirectangular(pano_images, u.reshape(B, S, window_size, window_size), v.reshape(B, S, window_size, window_size))
