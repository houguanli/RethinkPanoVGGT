...
try:
    ...
    try:
        ...
        def check_and_fix_inf_nan(tensor, name="tensor"):
...
class MultitaskLoss(torch.nn.Module):
    ...
    """
    def __init__(self, camera=None, depth=None, point=None, track=None, pano=None, **kwargs):
        super().__init__()
...
def compute_camera_loss(
    ...
    **kwargs
    ...
    gt_pose_encoding = _extri_intri_to_pose_encoding(
