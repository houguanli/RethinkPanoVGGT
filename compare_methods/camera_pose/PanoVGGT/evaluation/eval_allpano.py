...
def parse_args():
    ...
    p.add_argument("--panocity_root", type=str,
                   default=None,
                   help="Optional override for the PanoCity root. Defaults to DATASETS_ROOT/PanoCity.")
    p.add_argument("--matterport_root", type=str,
                   default=None,
                   help="Optional override for the Matterport3D root. Defaults to DATASETS_ROOT/Matterport3D.")
    p.add_argument("--stanford_root", type=str,
                   default=None,
                   help="Optional override for the Stanford2D3DS root. Defaults to DATASETS_ROOT/Stanford2D3DS.")
    p.add_argument("--structured3d_root", type=str,
                   default=None,
                   help="Optional override for the Structured3D root. Defaults to DATASETS_ROOT/Structured3D.")
