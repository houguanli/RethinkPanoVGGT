...
class Stanford2D3DSDataset(BaseDataset):
    ...
    def _project_split_path(self):
        ...
        return osp.join(data_dir, "splits", "stanford2d3ds", f"2d3ds_{self.mode}_index.json")
    ...
    def _load_project_split_index(self):
        ...
        try:
            ...
            if isinstance(data, list):
                logging.info(f"[ProjectSplit] Loaded Stanford2D3DS {self.mode} index from {split_path}")
                return data
