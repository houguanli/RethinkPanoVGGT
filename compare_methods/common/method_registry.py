...
METHODS: Dict[str, MethodSpec] = {
    ...
    "panovggt_multi_camera": MethodSpec(
        ...
        requirements=[COMPARE_ROOT / "camera_pose" / "PanoVGGT" / "requirements.txt"],
        config=COMPARE_ROOT / "configs" / "panovggt_camera_panocity_4rtx5000.yaml",
        finetune_command=["torchrun", "--standalone", "--nproc_per_node=4", "training/launch.py", "--config", "panocity_multi_4rtx5000"],
        evaluate_command=[
            "python", "point_optimize_panocity.py",
            "--config", "panocity_multi_4rtx5000",
            "--checkpoint", "logs/panocity_multi_4rtx5000/ckpts/checkpoint.pt",
            "--split", "test",
            "--max-samples", "32",
            "--output-dir", "outputs/panocity_multi_4rtx5000/point_opt",
        ],
        smoke_finetune_command=["torchrun", "--standalone", "--nproc_per_node=1", "training/launch.py", "--config", "panocity_smoke"],
        smoke_evaluate_command=[
            "python", "point_optimize_panocity.py",
    ...
    "panovggt_multi_depth": MethodSpec(
        name="panovggt_multi_depth",
        path=COMPARE_ROOT / "depth_geometry" / "PanoVGGT",
        env_name="cmp_panovggt",
        requirements=[COMPARE_ROOT / "depth_geometry" / "PanoVGGT" / "requirements.txt"],
        config=COMPARE_ROOT / "configs" / "panovggt_depth_panocity_4rtx5000.yaml",
        ...
        evaluate_command=[
            "python", "point_optimize_panocity.py",
            "--config", "panocity_multi_4rtx5000",
            "--checkpoint", "../../camera_pose/PanoVGGT/logs/panocity_multi_4rtx5000/ckpts/checkpoint.pt",
            "--split", "test",
            "--max-samples", "32",
            "--output-dir", "outputs/panocity_multi_4rtx5000/point_opt",
        ],
    ...
    "vggt_omega_camera": MethodSpec(
        ...
        evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_camera_panocity_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_4rtx5000/model.pt",
            "--split", "test",
            "--max-samples", "4",
            "--output-json", "outputs/panocity_4rtx5000/depth_check.json",
        ],
        ...
        smoke_evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_camera_panocity_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_deep_smoke/model.pt",
            "--split", "smoke",
            "--max-samples", "1",
            "--output-json", "outputs/panocity_deep_smoke/depth_check.json",
        ],
    ),
    "vggt_omega_depth": MethodSpec(
        ...
        evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_depth_panocity_4rtx5000.yaml",
            "--checkpoint", "../../camera_pose/VGGT-Omega/outputs/panocity_4rtx5000/model.pt",
            "--split", "test",
            "--max-samples", "4",
            "--output-json", "outputs/panocity_4rtx5000/depth_check.json",
        ],
        ...
        smoke_evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_depth_panocity_4rtx5000.yaml",
            "--checkpoint", "../../camera_pose/VGGT-Omega/outputs/panocity_deep_smoke/model.pt",
            "--split", "smoke",
            "--max-samples", "1",
            "--output-json", "outputs/panocity_deep_smoke/depth_check.json",
        ],
    ),
    "vggt_omega_multi_camera": MethodSpec(
        name="vggt_omega_multi_camera",
        path=COMPARE_ROOT / "camera_pose" / "VGGT-Omega",
        env_name="cmp_vggt_omega",
        requirements=[COMPARE_ROOT / "camera_pose" / "VGGT-Omega" / "requirements.txt"],
        editable=True,
        config=COMPARE_ROOT / "configs" / "vggt_omega_camera_panocity_multi_4rtx5000.yaml",
        finetune_command=["torchrun", "--standalone", "--nproc_per_node=4", "train_panocity.py", "--config", "../../configs/vggt_omega_camera_panocity_multi_4rtx5000.yaml", "--checkpoint", "../../../ckpt/VGGT-Omega/vggt_omega_1b_512.pt", "--output-dir", "outputs/panocity_multi_4rtx5000"],
        evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_camera_panocity_multi_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_multi_4rtx5000/model.pt",
            "--split", "test",
            "--max-samples", "4",
            "--output-json", "outputs/panocity_multi_4rtx5000/depth_check.json",
        ],
        smoke_finetune_command=["python", "train_panocity.py", "--config", "../../configs/vggt_omega_camera_panocity_multi_4rtx5000.yaml", "--checkpoint", "../../../ckpt/VGGT-Omega/vggt_omega_1b_512.pt", "--output-dir", "outputs/panocity_deep_smoke_multi", "--smoke", "--max-steps", "2"],
        smoke_evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_camera_panocity_multi_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_deep_smoke_multi/model.pt",
            "--split", "smoke",
            "--max-samples", "1",
            "--output-json", "outputs/panocity_deep_smoke_multi/depth_check.json",
        ],
    ),
    "vggt_omega_multi_depth": MethodSpec(
        name="vggt_omega_multi_depth",
        path=COMPARE_ROOT / "depth_geometry" / "VGGT-Omega",
        env_name="cmp_vggt_omega",
        requirements=[COMPARE_ROOT / "depth_geometry" / "VGGT-Omega" / "requirements.txt"],
        editable=True,
        config=COMPARE_ROOT / "configs" / "vggt_omega_depth_panocity_multi_4rtx5000.yaml",
        finetune_command=["torchrun", "--standalone", "--nproc_per_node=4", "train_panocity.py", "--config", "../../configs/vggt_omega_depth_panocity_multi_4rtx5000.yaml", "--checkpoint", "../../../ckpt/VGGT-Omega/vggt_omega_1b_512.pt", "--output-dir", "outputs/panocity_multi_4rtx5000"],
        evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_depth_panocity_multi_4rtx5000.yaml",
            "--checkpoint", "../../camera_pose/VGGT-Omega/outputs/panocity_multi_4rtx5000/model.pt",
            "--split", "test",
            "--max-samples", "4",
            "--output-json", "outputs/panocity_multi_4rtx5000/depth_check.json",
        ],
        smoke_finetune_command=["python", "train_panocity.py", "--config", "../../configs/vggt_omega_depth_panocity_multi_4rtx5000.yaml", "--checkpoint", "../../../ckpt/VGGT-Omega/vggt_omega_1b_512.pt", "--output-dir", "outputs/panocity_deep_smoke_multi", "--smoke", "--max-steps", "2"],
        smoke_evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "../../configs/vggt_omega_depth_panocity_multi_4rtx5000.yaml",
            "--checkpoint", "../../camera_pose/VGGT-Omega/outputs/panocity_deep_smoke_multi/model.pt",
            "--split", "smoke",
            "--max-samples", "1",
            "--output-json", "outputs/panocity_deep_smoke_multi/depth_check.json",
        ],
    ...
    "dap": MethodSpec(
        ...
        evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "config/train_panocity_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_4rtx5000/model.pth",
            "--split", "test",
            "--max-samples", "4",
            "--output-json", "outputs/panocity_4rtx5000/depth_check.json",
        ],
        ...
        smoke_evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "config/train_panocity_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_deep_smoke/model.pth",
            "--split", "smoke",
            "--max-samples", "1",
            "--output-json", "outputs/panocity_deep_smoke/depth_check.json",
        ],
    ...
    "panda": MethodSpec(
        ...
        evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "config/metric_depth/train_panocity_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_4rtx5000/best/model.pth",
            "--split", "test",
            "--max-samples", "4",
            "--output-json", "outputs/panocity_4rtx5000/depth_check.json",
        ],
        ...
        smoke_evaluate_command=[
            "python", "check_panocity_depth.py",
            "--config", "config/metric_depth/train_panocity_4rtx5000.yaml",
            "--checkpoint", "outputs/panocity_deep_smoke/best/model.pth",
            "--split", "smoke",
            "--max-samples", "1",
            "--output-json", "outputs/panocity_deep_smoke/depth_check.json",
        ],
...
GROUPS: Dict[str, MethodGroup] = {
    ...
    "panovggt_single": MethodGroup(
        name="panovggt_single",
        env_name="cmp_panovggt",
        finetune_method="panovggt_camera",
        evaluate_methods=["panovggt_camera", "panovggt_depth"],
    ),
    "panovggt_multi": MethodGroup(
        name="panovggt_multi",
        env_name="cmp_panovggt",
        finetune_method="panovggt_multi_camera",
        evaluate_methods=["panovggt_multi_camera", "panovggt_multi_depth"],
    ),
    "reloc3r": MethodGroup(
        name="reloc3r",
        env_name="cmp_reloc3r",
    ...
    "vggt_omega_single": MethodGroup(
        name="vggt_omega_single",
        env_name="cmp_vggt_omega",
        finetune_method="vggt_omega_camera",
        evaluate_methods=["vggt_omega_camera", "vggt_omega_depth"],
    ),
    "vggt_omega_multi": MethodGroup(
        name="vggt_omega_multi",
        env_name="cmp_vggt_omega",
        finetune_method="vggt_omega_multi_camera",
        evaluate_methods=["vggt_omega_multi_camera", "vggt_omega_multi_depth"],
    ),
    "dap": MethodGroup(
        name="dap",
        env_name="cmp_dap",
...
ALIASES: Dict[str, str] = {
    ...
    "vggtomegamulti": "vggt_omega_multi",
