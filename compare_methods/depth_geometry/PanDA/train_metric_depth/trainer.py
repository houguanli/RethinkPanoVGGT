...
class Trainer:
    ...
    def process_batch(self, inputs, val):
        ...
        # print(loss_basic.item(), outputs['pred_depth'].max().item(), outputs['pred_depth'].min().item())
        ...
        # print(loss_basic.item(), loss_second.item(), outputs['pred_depth'].max().item(), outputs['pred_depth'].min().item())
        ...
        # print(loss_basic.item(), loss_second.item(), loss_third.item(), outputs['pred_depth'].max().item(), outputs['pred_depth'].min().item())
